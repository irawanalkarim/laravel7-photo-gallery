...
Route::group(['middleware' => 'auth'], function() {
    Route::prefix('/user/')->group(function() {
        ...
        Route::get('galleries/delete/{id}', 'GalleryController@galleryDelete')->name('galleryDelete');
        ...
        Route::get('galleries/photos/delete/{id}', 'GalleryController@photoDelete')->name('photoDelete');
    });
});
